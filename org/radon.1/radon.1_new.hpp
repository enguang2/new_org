...
namespace radonx461_new_model_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 10, column 2 to column 12)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 11, column 2 to column 9)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 12, column 2 to column 12)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 13, column 2 to column 24)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 14, column 2 to column 24)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 22, column 0 to column 9)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 23, column 0 to column 8)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 25, column 4 to column 71)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 24, column 15 to line 26, column 1)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 24, column 0 to line 26, column 1)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 17, column 2 to column 28)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 19, column 4 to column 52)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 18, column 2 to line 19, column 52)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 2, column 2 to column 17)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 3, column 2 to column 17)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 4, column 9 to column 10)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 4, column 2 to column 14)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 5, column 25 to column 26)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 5, column 2 to column 28)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 6, column 13 to column 14)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 6, column 2 to column 16)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 7, column 9 to column 10)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 7, column 2 to column 19)",
                                                      " (in 'org/radon.1/radon.1_new.stan', line 10, column 9 to column 10)"};



class radonx461_new_model final : public model_base_crtp<radonx461_new_model> {
 ...
 public:
  ...
  inline std::string model_name() const final { return "radonx461_new_model"; }
  ...
  radonx461_new_model(stan::io::var_context& context__,
    ...
    static const char* function__ = "radonx461_new_model_namespace::radonx461_new_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "radonx461_new_model_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      a = std::vector<local_scalar_t__>(J, DUMMY_VAR__);
      ...
      }
      {
        ...
        for (int n = 1; n <= N; ++n) {
          ...
          lp_accum__.add(
            normal_lpdf<propto__>(y[(n - 1)],
              (a[(county[(n - 1)] - 1)] + (b * x[(n - 1)])), sigma_y));}
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "radonx461_new_model_namespace::write_array";
(void) function__;  // suppress unused var warning
    ...
    try {
      std::vector<double> a;
      a = std::vector<double>(J, std::numeric_limits<double>::quiet_NaN());
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"a\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu_a\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_y\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_a\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lik\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = radonx461_new_model_namespace::radonx461_new_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return radonx461_new_model_namespace::profiles__;
}
