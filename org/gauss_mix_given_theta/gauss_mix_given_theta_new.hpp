...
namespace gauss_mix_given_theta_new_model_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 9, column 2 to column 16)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 10, column 2 to column 25)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 22, column 0 to column 9)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 23, column 0 to column 8)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 25, column 3 to line 27, column 71)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 24, column 23 to line 28, column 1)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 24, column 0 to line 28, column 1)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 14, column 1 to column 22)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 15, column 1 to column 19)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 17, column 3 to line 19, column 58)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 16, column 1 to line 19, column 58)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 2, column 1 to column 18)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 3, column 8 to column 9)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 3, column 1 to column 13)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 4, column 1 to column 30)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 5, column 9 to column 10)",
                                                      " (in 'org/gauss_mix_given_theta/gauss_mix_given_theta_new.stan', line 5, column 2 to column 19)"};



class gauss_mix_given_theta_new_model final : public model_base_crtp<gauss_mix_given_theta_new_model> {
 ...
 public:
  ~gauss_mix_given_theta_new_model() { }
  
  inline std::string model_name() const final { return "gauss_mix_given_theta_new_model"; }
  ...
  gauss_mix_given_theta_new_model(stan::io::var_context& context__,
    ...
    static const char* function__ = "gauss_mix_given_theta_new_model_namespace::gauss_mix_given_theta_new_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "gauss_mix_given_theta_new_model_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "gauss_mix_given_theta_new_model_namespace::write_array";
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << 2 << "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"array\",\"length\":" << 2 << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"lik\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = gauss_mix_given_theta_new_model_namespace::gauss_mix_given_theta_new_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return gauss_mix_given_theta_new_model_namespace::profiles__;
}
